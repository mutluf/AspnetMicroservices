...
namespace Shopping.RazorWebApp.Data
{
    public class ShoppingContextSeed
    {
        public static async Task SeedAsync(ShoppingDbContext aspnetrunContext, ILoggerFactory loggerFactory, int? retry = 0)
        {
            ...
            catch (Exception exception)
            {
                if (retryForAvailability < 10)
                {
                    ...
                    var log = loggerFactory.CreateLogger<ShoppingContextSeed>();
